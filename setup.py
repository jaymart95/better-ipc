...
setuptools.setup(
    ...
    description="A high-performance inter-process communication library designed to work with the latest version of disnake.py",
    packages=[
        "disnake.ext.ipc"
    ],
    project_urls={
    ...
    keywords=["better-ipc", "ipc", "python", "disnake.py"],
